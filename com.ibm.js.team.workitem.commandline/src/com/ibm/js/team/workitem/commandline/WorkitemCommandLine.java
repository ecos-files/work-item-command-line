...
public class WorkitemCommandLine extends UnicastRemoteObject implements
	...
	protected HashMap<String, IWorkItemCommand> supportedCommands = new HashMap<String, IWorkItemCommand>();
	 ...
	 */
	protected static void setServer(boolean value) {
		isServer = value;
	}
	 ...
	 */
	protected void addSupportedCommands(ParameterManager parameterManager) {
...
//				parameterManager.getArguments())));
		...
		addSupportedCommand(new ValidateOSLCLinksCommand(new ParameterManager(
				parameterManager.getArguments())));
		addSupportedCommand(new FindEnumerationIdConflictsCommand(new ParameterManager(
				parameterManager.getArguments())));
		addSupportedCommand(new FindInProjectAreasCommand(new ParameterManager(
				parameterManager.getArguments())));
		...
		addSupportedCommand(new ExportWorkItemsCommand(new ParameterManager(
				parameterManager.getArguments())));
		addSupportedCommand(new ValidateWorkItemStatesCommand(new ParameterManager(
				parameterManager.getArguments())));
	 ...
	 */
	protected HashMap<String, IWorkItemCommand> getSupportedCommands() {
	 ...
	 */
	protected void addSupportedCommand(IWorkItemCommand command) {
		command.initialize();
	 ...
	 */
	protected IWorkItemCommand getSupportedCommand(String commandName) {
	...
	protected OperationResult run(String[] args) {
		ParameterManager parameterManager = new ParameterManager(
				ParameterParser.parseParameters(args));
		System.out.println("Ignore log4j Appender and Missing Configuration warnings.");
	 ...
	 * @return
	 */
	protected String helpGeneralUsage(String theCommand) {
